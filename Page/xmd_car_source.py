...
def web_shenhe():
    ...
    driver.get(
        "http://uat.crm.yxqiche.com/casserver/login?service=http://test.cheyuan.taoche.com/car-audit-api/shiro-cas")
    ...
    driver.find_element_by_xpath(
        '//*[@id="root"]/div/div/div[2]/div[2]/div/div[1]/div/form/div[8]/div/div/div/span/div/div/div/span/button[1]').click()
    sleep(2)
    # 点击审核按钮
    driver.find_element_by_xpath(
        '//*[@id="root"]/div/div/div[2]/div[2]/div/div[3]/div/div/div/div/div/div[3]/div/div/table/tbody/tr[1]/td[2]/div/div').click()
    sleep(2)
    driver.find_element_by_xpath(
        '//*[@id="extension"]/div[2]/div/div/div/div/div/div/table/tbody/tr[2]/td[1]/span/label/span/input').click()
    sleep(3)
    driver.find_element_by_xpath(
        '//*[@id="root"]/div/div/div[2]/div[2]/div/div[2]/div/div/div[4]/div/button[2]').click()
...
class cheyuan(Base):
    ...
    # 登录采集车源账号
    def input_login(self, name="10000000888", passwo="uat.portal"):
