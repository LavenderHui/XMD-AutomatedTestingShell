...
import allure
from Page.xmd_car_source import cheyuan
...
class Test_1:
    ...
    def setup_class(self):
        self.obj = cheyuan(get_driver())

    @allure.step(title="输入账号密码")
    def test_process_dl(self):
    ...
    def test_verify_click_backlog(self):
    ...
    def test_verify_name_seek(self):
        self.obj.input_seek()

    @allure.step(title="点击搜索到的门店提示")
    def test_verify_seek_cj(self):
    ...
    def test_verify_click_shop_1(self):
        self.obj.click_shop_1()

    @allure.step(title="在添加车源页左上角点击返回")
    def test_verify_fh(self):
        self.obj.virify_fh()

    @allure.step(title="在添加车源页左上角点击返回,选择是")
    def test_verify_Return_to_save(self):
    ...
    def test_process_input_vin(self):
        self.obj.input_vin()
    ...
    def test_process_cyxj(self):
        self.obj.ckick_cyxj()

    @allure.step(title="拍摄车辆照片")
    def test_process_clzp(self):
    ...
    def test_process_clbz(self):
        self.obj.input_clbz()
        self.obj.input_clms()

    @allure.step(title="点击保存按钮")
    def test_process_sc(self):
        self.obj.click_baoc()
